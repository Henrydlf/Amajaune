...
<div class="btn-group">
  <button type="button" class="btn btn-default">Taille</button>
...
<br><br>
   ...
   <div class="btn-group">
  <button type="button" class="btn btn-default">Couleur</button>
  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">    <span class="caret"></span>
   <span class="sr-only">Toggle Dropdown</span>
  </button>
  <ul class="dropdown-menu">
     ...
     <li><a href="#" title="magenta avec des reflets cyan">magenta avec des reflets cyan</a></li> 
  </ul>
</div>
